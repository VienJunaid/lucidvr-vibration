...
void setupInputs(){
  ...
  // limit‑button inputs:
  pinMode(PIN_LIMIT_THUMB_BTN,  INPUT_PULLUP);
  pinMode(PIN_LIMIT_INDEX_BTN,  INPUT_PULLUP);
  pinMode(PIN_LIMIT_MIDDLE_BTN, INPUT_PULLUP);
  pinMode(PIN_LIMIT_RING_BTN,   INPUT_PULLUP);
  pinMode(PIN_LIMIT_PINKY_BTN,  INPUT_PULLUP);
}
